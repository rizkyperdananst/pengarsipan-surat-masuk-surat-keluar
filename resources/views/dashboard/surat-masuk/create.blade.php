                         ...
                         <form action="{{ route('surat-masuk.store') }}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="row mb-3">
                                   ...
                                   <div class="col-md-6">
                                        ...
                                        <input type="text" name="sifat_surat" id="sifat_surat" class="form-control @error('sifat_surat') is-invalid @enderror" placeholder="masukkan sifat surat">
                                        @error('sifat_surat')
                                            <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                                        @enderror
                                   </div>
                              ...
                              <div class="row mb-3">
                                   <div class="col-md-6">
                                        ...
                                        <input type="text" name="asal_surat" id="asal_surat" class="form-control @error('asal_surat') is-invalid @enderror" placeholder="masukkan asal surat">
                                        @error('asal_surat')
                                            <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                                        @enderror
                                   </div>
                              ...
                              <div class="row mb-3">
                                   <div class="col-md-6">
                                        ...
                                        <input type="date" name="tanggal_diterima" id="tanggal_diterima" class="form-control @error('tanggal_diterima') is-invalid @enderror">
